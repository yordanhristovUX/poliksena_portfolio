...
export const tokens = {
  ...
  colorSemanticBackgroundDefault: { cssVar: '--color-semantic-background-default', value: '#000000' },
  colorSemanticBackgroundSubtle: { cssVar: '--color-semantic-background-subtle', value: '#141414' },
  colorSemanticBackgroundMuted: { cssVar: '--color-semantic-background-muted', value: '#2c2c2c' },
  colorSemanticBackgroundInverted: { cssVar: '--color-semantic-background-inverted', value: '#ffffff' },
  colorSemanticForegroundDefault: { cssVar: '--color-semantic-foreground-default', value: '#ffffff' },
  colorSemanticForegroundMuted: { cssVar: '--color-semantic-foreground-muted', value: '#999999' },
  colorSemanticForegroundSubtle: { cssVar: '--color-semantic-foreground-subtle', value: '#959595' },
  colorSemanticForegroundInverted: { cssVar: '--color-semantic-foreground-inverted', value: '#000000' },
  colorSemanticBorderDefault: { cssVar: '--color-semantic-border-default', value: '#2c2c2c' },
  colorSemanticBorderStrong: { cssVar: '--color-semantic-border-strong', value: '#404540' },
